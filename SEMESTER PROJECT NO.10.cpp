    ...
    string doctor_Name[], int prices[])
{
    ...
    PrintHospitalBycity("Komfo Anokye Teaching Hospital(KATH)", hospitals);
...
int main()
{
    ...
    // the user data
    string patient_Name[] = { "ASANTE", "GIDEON", "LOVIA", "GRACE" };
    int patient_Id[] = { 2, 3, 4, 1 };
    string patient_Contact[]
        = { "2345345097", "2345763482", "8574651259",
            "5676575980" };
    int bookingCost[] = { 1000, 1200, 1100, 600 };
  
    string hospital_Name[] = { "SDA HOSPITAL KWADASO", "KATH", "SENTRESO HOSPITAL", "AFARI HOSPITAL" };
    string locations[] = { "Kumasi", "Kwadaso",
                           "BANTAMA   ", "ADUM" };
    int beds[] = { 4, 5, 6, 9 };
    float ratings[] = { 5.2, 4.1, 3.4, 5.9 };
    string hospital_Contact[]
        = { "6575346547", "2987661342", "3245658769",
            "3434563564" };
    string doctor_Name[] = { "Dr. Amuzu", "Dr. Grace Boadu", "Dr. Nsiah Asare", "Dr. Fodjour" };
